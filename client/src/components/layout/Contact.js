...
export default function Contact() {
  ...
  return (
    <div className="page">
      <div className=" card border-warning text-white text-center" id="bg" >
        <div className="card-header" >CONTACT US</div>
        <div>
          <div className="lead card-title m-3" >We'd <FavoriteBorderIcon /> to help</div>
          <div className="card-text">
            <div className="card-group">
              <div className=" card border-secondary text-white text-left" id="bg" style={{ maxwidth: '150px', borderRadius: '1rem', margin: '2rem', padding: '1rem' }} >
              ...
              <div className=" card text-white " id="bg">

                <form className="form" onSubmit={submit}>
                  <div className="form-inline">
                    <label id="label0" htmlFor="user-email">Email</label>
                    <input
                      id="user-email"
                      type="text"
                  ...
                  <div className="form-inline">
                    <label id="label1" htmlFor="meggage-area">Message</label>
                    <textarea className="msg-area" id="meggage-area" rows="3" onChange={(e) => setMessage(e.target.value)}></textarea>
                  </div>
                  <hr />
                  <Button className='msg-btn btn-1 btn-warning' type="submit">Submit</Button>
                </form>
